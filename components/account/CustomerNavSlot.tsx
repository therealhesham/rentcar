...
export function CustomerNavSlot({ variant = "light" }: { variant?: "light" | "dark" }) {
  ...
  if (me) {
    ...
    if (variant === "dark") {
      return (
        ...
        >
          <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-[#f5821f] to-[#d9690a] text-sm font-extrabold text-white shadow-sm ring-2 ring-[#f5821f]/30">
    ...
    return (
      <Link
        ...
        title={me.name?.trim() || me.email}
        aria-label={t("accountOf", { name: displayName })}
        className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-[#f5821f] to-[#d9690a] text-[12.5px] font-extrabold text-white shadow-[0_4px_14px_-4px_rgba(219,184,120,0.45)] outline-none ring-1 ring-[#f5821f]/35 transition-transform hover:scale-105 focus-visible:ring-2 focus-visible:ring-[#163332]/45 sm:h-11 sm:w-11 sm:text-[13px]"
      >
        <span
          dir="ltr"
  ...
  if (variant === "dark") {
    return (
      <div className="flex w-full flex-col gap-2.5">
        <Link
          href="/account/login"
          className="flex w-full items-center justify-center rounded-xl bg-[#f5821f] px-4 py-3 text-sm font-bold text-[#1e293b] shadow-[0_4px_16px_rgba(219,184,120,0.2)] transition-transform hover:scale-[1.02] active:scale-[0.98]"
        >
          {t("login")}
        </Link>
        {/* <Link
  ...
  return (
    ...
    >
      <Link
        href="/account/login"
        className="rounded-full bg-[#163332] px-3 py-2 text-white shadow-sm outline-none transition-opacity hover:opacity-95 focus-visible:ring-2 focus-visible:ring-[#f5821f]/45 sm:px-4"
      >
        {t("login")}
      </Link>
      ...
      <Link
        href="/account/register"
        className="rounded-full border border-[#163332]/25 bg-white/90 px-3 py-2 text-[#163332] shadow-sm outline-none transition-colors hover:bg-[#163332]/5 focus-visible:ring-2 focus-visible:ring-[#f5821f]/45 sm:px-4"
      >
        {t("register")}
      </Link> */}
    </div>
