...
const METHOD_FIELDS: {
  ...
  },
  {
    ...
    hint: "فيزا / ماستركارد مع نموذج بيانات البطاقة.",
  },
  {
    key: "MADA",
    label: "مدى",
    hint: "الدفع ببطاقة مدى — نموذج بيانات البطاقة في صفحة الدفع.",
  },
  {
    key: "AMKAN",
    label: "إمكان",
    hint: "خدمة إمكان — يظهر كخيار دفع منفصل (ربط البوابة لاحقاً).",
  },
  {
    key: "CASH",
    label: "الدفع عند الفرع",
    hint: "يدفع العميل المبلغ عند الاستلام أو في الفرع — يُسجَّل الطلب كمدفوع للاختبار.",
  },
  {
    key: "APPLE_PAY",
    label: "Apple Pay",
