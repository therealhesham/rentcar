...
import { deleteCustomizedCoupon, type ActionState } from "@/app/admin/customized-coupon-actions";

export function CustomizedCouponDeleteForm({ id, code }: { id: number; code: string }) {
  const [state, formAction, pending] = useActionState(
    deleteCustomizedCoupon,
