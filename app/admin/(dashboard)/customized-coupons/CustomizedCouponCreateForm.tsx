...
import { createCustomizedCoupon, type ActionState } from "@/app/admin/customized-coupon-actions";
import { CustomizedCouponFields } from "@/app/admin/(dashboard)/customized-coupons/CustomizedCouponFields";

export function CustomizedCouponCreateForm() {
  const [state, formAction, pending] = useActionState(
    createCustomizedCoupon,
  ...
  return (
    ...
    >
      <h2 className="text-lg font-extrabold tracking-tight md:col-span-2">إضافة كود خصم مخصَّص</h2>
